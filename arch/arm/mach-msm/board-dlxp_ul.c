...
#endif
extern int msm_get_cpu_speed_bin(void);
int dlp_ext_buck_en(int en)
{
	if (msm_get_cpu_speed_bin()==2)
	{
		gpio_direction_output(PM8921_GPIO_PM_TO_SYS(2), en);
		gpio_direction_output(PM8921_GPIO_PM_TO_SYS(10), en);
	}
	return 0;
}
