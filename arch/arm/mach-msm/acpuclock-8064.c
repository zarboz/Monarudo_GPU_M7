...
static struct l2_level l2_freq_tbl[] = {
	...
	[1]  = { {  384000, HFPLL, 2, 0x20 }, 1050000, 1050000, 1 },
	[2]  = { {  432000, HFPLL, 2, 0x22 }, 1050000, 1050000, 2 },
	...
	[11] = { {  918000, HFPLL, 1, 0x22 }, 1150000, 1150000, 7 },
	[12] = { {  972000, HFPLL, 1, 0x24 }, 1150000, 1150000, 7 },
	[13] = { { 1026000, HFPLL, 1, 0x26 }, 1150000, 1150000, 7 },
	[14] = { { 1080000, HFPLL, 1, 0x28 }, 1150000, 1150000, 7 },
	[15] = { { 1134000, HFPLL, 1, 0x2A }, 1150000, 1150000, 7 },
	[16] = { { 1188000, HFPLL, 1, 0x2C }, 1150000, 1150000, 8 },
	[17] = { { 1350000, HFPLL, 1, 0x32 }, 1150000, 1150000, 8 },
	{ }
};

static struct acpu_level tbl_slow[] __initdata = {
	{ 1, {   162000, HFPLL, 2, 0x0C }, L2(1),   975000 },
  	{ 1, {	 175500, HFPLL, 2, 0x0D }, L2(1),   975000 },
   	{ 1, {	 189000, HFPLL, 2, 0x0E }, L2(1),   975000 },	
	{ 1, {	 216000, HFPLL, 2, 0x10 }, L2(1),   975000 },
	{ 1, { 	 270000, HFPLL, 2, 0x14 }, L2(1),   950000 },
	{ 1, {   324000, HFPLL, 2, 0x18 }, L2(1),   950000 },
	{ 1, {   378000, HFPLL, 2, 0x1C }, L2(1),   950000 },
	...
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(16), 1250000 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(17), 1275000 },
	{ 1, {  1782000, HFPLL, 1, 0x42 }, L2(17), 1275000 },
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(17), 1275000 },
	{ 0, { 0 } }
};

static struct acpu_level tbl_nom[] __initdata = {
	{ 1, {   162000, HFPLL, 2, 0x0C }, L2(1),   925000 },
    { 1, {	 175500, HFPLL, 2, 0x0D }, L2(1),   925000 },
    { 1, {	 189000, HFPLL, 2, 0x0E }, L2(1),   925000 },	
	{ 1, {	 216000, HFPLL, 2, 0x10 }, L2(1),   925000 },
	{ 1, { 	 270000, HFPLL, 2, 0x14 }, L2(1),   925000 },
	{ 1, {   324000, HFPLL, 2, 0x18 }, L2(1),   900000 },
	{ 1, {   378000, HFPLL, 2, 0x1C }, L2(1),   900000 },
...
static struct acpu_level tbl_fast[] __initdata = {
    ...
    { 1, {	 175500, HFPLL, 2, 0x0D }, L2(1),   875000 },
    { 1, {	 189000, HFPLL, 2, 0x0E }, L2(1),   875000 },	
	{ 1, {	 216000, HFPLL, 2, 0x10 }, L2(1),   850000 },
	{ 1, { 	 270000, HFPLL, 2, 0x14 }, L2(1),   850000 },
	{ 1, {   324000, HFPLL, 2, 0x18 }, L2(1),   850000 },
	{ 1, {   378000, HFPLL, 2, 0x1C }, L2(1),   850000 },
...
static struct acpu_level tbl_faster[] __initdata = {
    ...
    { 1, {	 175500, HFPLL, 2, 0x0D }, L2(1),   875000 },
    { 1, {	 189000, HFPLL, 2, 0x0E }, L2(1),   875000 },	
	{ 1, {	 216000, HFPLL, 2, 0x10 }, L2(1),   875000 },
	{ 1, { 	 270000, HFPLL, 2, 0x14 }, L2(1),   875000 },
	...
	{ 0, {   648000, HFPLL, 1, 0x18 }, L2(7),   925000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(7),   925000 },
	{ 0, {   756000, HFPLL, 1, 0x1C }, L2(7),   962500 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(7),   962500 },
	{ 0, {   864000, HFPLL, 1, 0x20 }, L2(7),   975000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(7),   975000 },
	{ 0, {   972000, HFPLL, 1, 0x24 }, L2(7),  1000000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(7),  1000000 },
