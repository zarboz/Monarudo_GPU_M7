...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[15] = { { 1242000, HFPLL, 1, 0x2E }, 1175000, 1175000, 5 },
	[16] = { { 1296000, HFPLL, 1, 0x30 }, 1175000, 1175000, 5 },
	[17] = { { 1350000, HFPLL, 1, 0x32 }, 1175000, 1175000, 5 },
	{ }
};
...
static struct acpu_level tbl_PVS0_1700MHz[] __initdata = {
		...
		{ 1, {  1782000, HFPLL, 1, 0x42 }, L2(16), 1275000 },
...
static struct acpu_level tbl_PVS1_1700MHz[] __initdata = {
        ...
        { 1, {  1836000, HFPLL, 1, 0x44 }, L2(16), 1250000 },
...
static struct acpu_level tbl_PVS3_1700MHz[] __initdata = {
        ...
        { 1, {  1890000, HFPLL, 1, 0x46 }, L2(17), 1212500 },
   	 	//{ 1, {  1917000, HFPLL, 1, 0x47 }, L2(15), 1225000 },
...
static struct acpu_level tbl_PVS4_1700MHz[] __initdata = {
        ...
        { 1, {  1836000, HFPLL, 1, 0x44 }, L2(16), 1150000 },
        { 1, {  1890000, HFPLL, 1, 0x46 }, L2(17), 1200000 },
    	//{ 1, {  1917000, HFPLL, 1, 0x47 }, L2(15), 1212500 },
...
static struct acpu_level tbl_PVS5_1700MHz[] __initdata = {
		...
		{ 1, {  1782000, HFPLL, 1, 0x42 }, L2(16), 1100000 },
        { 1, {  1836000, HFPLL, 1, 0x44 }, L2(17), 1125000 },
        { 1, {  1890000, HFPLL, 1, 0x46 }, L2(17), 1175000 },
    	//{ 1, {  1917000, HFPLL, 1, 0x47 }, L2(15), 1200000 },
...
static struct acpu_level tbl_PVS6_1700MHz[] __initdata = {
        ...
        { 1, {  1836000, HFPLL, 1, 0x44 }, L2(17), 1100000 },
        { 1, {  1890000, HFPLL, 1, 0x46 }, L2(17), 1150000 },
    	//{ 1, {  1917000, HFPLL, 1, 0x47 }, L2(15), 1175000 },
